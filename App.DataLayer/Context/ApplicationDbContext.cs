...
using App.Common.EFCoreToolkit;
using App.DataLayer.Configurations;
...
namespace App.DataLayer.Context
{
        ...
        IUnitOfWork
    {
        ...
        public virtual DbSet<LocationLog> LocationLogs { set; get; }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            // Select queries with check soft delete property
            builder.FilterSelectQueries();
        }
