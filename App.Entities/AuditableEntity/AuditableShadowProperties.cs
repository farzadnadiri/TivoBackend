...
using App.Common.IdentityToolkit;

namespace App.Entities.AuditableEntity
{
    ...
    public static class AuditableShadowProperties
    {
        ...
        public static void FilterSelectQueries(this ModelBuilder modelBuilder)
        {
                ...
                .Where(e => typeof(IAuditableEntity).IsAssignableFrom(e.ClrType)))
            {
                ...
                var isDeletedProperty = Expression.Call(propertyMethodInfo, parameter, Expression.Constant(nameof(IsDeleted)));
            ...
            IHttpContextAccessor httpContextAccessor)
        {
            ...
            // Soft Delete
            var deletedEntries = changeTracker.Entries<IAuditableEntity>()
