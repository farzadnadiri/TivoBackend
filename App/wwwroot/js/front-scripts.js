...
(function($) {
    ...
    $("#signUpForm").validator().on("submit", function(event) {
    	if (event.isDefaultPrevented()) {
            ...
            sformError();
            ssubmitMSG(false, "لطفا تمام فیلدها را پر نمایید");
        } else {
    ...
    $("#logInForm").validator().on("submit", function(event) {
    	if (event.isDefaultPrevented()) {
            // handle the invalid form...
            lformError();
            lsubmitMSG(false, "لطفا تمام فیلدها را پر نمایید");
        } else {
            // everything looks good!
            event.preventDefault();
            lsubmitForm();
    ...
    $("#newsletterForm").validator().on("submit", function(event) {
    	if (event.isDefaultPrevented()) {
            // handle the invalid form...
            nformError();
            nsubmitMSG(false, "لطفا تمام فیلدها را پر نمایید");
        } else {
            // everything looks good!
            event.preventDefault();
            nsubmitForm();
    ...
    $("#privacyForm").validator().on("submit", function(event) {
    	if (event.isDefaultPrevented()) {
            // handle the invalid form...
            pformError();
            psubmitMSG(false, "لطفا تمام فیلدها را پر نمایید");
        } else {
            // everything looks good!
            event.preventDefault();
            psubmitForm();
